...
public class OrderCompletedTabFragment extends Fragment {
    Context context;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_order_completed_tab, container, false);
    ...
    private void initUi(View view) {
        ...
        recyclerView = view.findViewById(R.id.recOrderSuccess);
